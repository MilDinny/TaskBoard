#Перемещены кнопки в другие места
...
class Application(tk.Tk):
    ...
    def create_widgets(self):
        ...
        tk.Label(self, text="Логин:", font=("Helvetica", 14)).grid(row=0, column=0, sticky=tk.E, padx=10, pady=10)
        self.entry_username = tk.Entry(self, font=("Helvetica", 14))
        self.entry_username.grid(row=0, column=1, sticky=tk.W, padx=10, pady=10)

        tk.Label(self, text="Пароль:", font=("Helvetica", 14)).grid(row=1, column=0, sticky=tk.E, padx=10, pady=10)
        self.entry_password = tk.Entry(self, show="*", font=("Helvetica", 14))
        self.entry_password.grid(row=1, column=1, sticky=tk.W, padx=10, pady=10)
...
class MainWindow(tk.Tk):
    ...
    def create_widgets(self):
        ...
        self.current_time_label.grid(row=0, column=0, columnspan=3, pady=10, sticky=tk.N)

        tk.Label(self, text="Название проекта:", font=("Helvetica", 14)).grid(row=1, column=0, sticky=tk.E, padx=10,
                                                                              pady=10)
        self.entry_project_name = tk.Entry(self, font=("Helvetica", 14))
        self.entry_project_name.grid(row=1, column=1, columnspan=2, sticky=tk.W, padx=10, pady=10)

        tk.Label(self, text="Тип проекта:", font=("Helvetica", 14)).grid(row=2, column=0, sticky=tk.E, padx=10, pady=10)
        self.entry_project_type = tk.Entry(self, font=("Helvetica", 14))
        self.entry_project_type.grid(row=2, column=1, columnspan=2, sticky=tk.W, padx=10, pady=10)

        tk.Label(self, text="Дата начала:", font=("Helvetica", 14)).grid(row=3, column=0, sticky=tk.E, padx=10, pady=10)
        self.entry_start_date = tk.Entry(self, font=("Helvetica", 14))
        self.entry_start_date.grid(row=3, column=1, columnspan=2, sticky=tk.W, padx=10, pady=10)

        tk.Label(self, text="Дата окончания:", font=("Helvetica", 14)).grid(row=4, column=0, sticky=tk.E, padx=10,
                                                                            pady=10)
        self.entry_end_date = tk.Entry(self, font=("Helvetica", 14))
        self.entry_end_date.grid(row=4, column=1, columnspan=2, sticky=tk.W, padx=10, pady=10)

        tk.Label(self, text="Прикрепленный файл:", font=("Helvetica", 14)).grid(row=5, column=0, sticky=tk.E, padx=10,
                                                                                pady=10)
        ...
        # Обрамление для кнопок в правом верхнем углу
        self.right_frame = tk.Frame(self)
        self.right_frame.grid(row=1, column=3, rowspan=5, sticky=(tk.N, tk.E, tk.S), padx=10, pady=10)

        tk.Button(self.right_frame, text="Список пользователей", command=self.show_users, font=("Helvetica", 14)).pack(
            pady=10)
        tk.Button(self.right_frame, text="Удалить свой аккаунт", command=self.delete_own_account,
