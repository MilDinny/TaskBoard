...
#Добавлено меню, отображающие всех пользователей, зарегестрированных за всё время
...
class Application(tk.Tk):
    ...
    def create_widgets(self):
        ...
        tk.Label(self, text="Логин:").grid(row=0, column=0, sticky=tk.W, padx=10, pady=5)
        self.entry_username = tk.Entry(self)
        self.entry_username.grid(row=0, column=1, sticky=(tk.W, tk.E), padx=10, pady=5)

        tk.Label(self, text="Пароль:").grid(row=1, column=0, sticky=tk.W, padx=10, pady=5)
        ...
        tk.Button(self, text="Регистрация", command=self.register).grid(row=3, column=0, columnspan=2, pady=5)
...
class MainWindow(tk.Tk):
    ...
    def create_widgets(self):
        ...
        tk.Label(self, text="Название проекта:").grid(row=1, column=0, sticky=tk.W, padx=10, pady=5)
        ...
        tk.Label(self, text="Тип проекта:").grid(row=2, column=0, sticky=tk.W, padx=10, pady=5)
        ...
        tk.Label(self, text="Дата начала:").grid(row=3, column=0, sticky=tk.W, padx=10, pady=5)
        ...
        tk.Label(self, text="Дата окончания:").grid(row=4, column=0, sticky=tk.W, padx=10, pady=5)
        self.entry_end_date = tk.Entry(self)
        self.entry_end_date.grid(row=4, column=1, columnspan=2, sticky=(tk.W, tk.E), padx=10, pady=5)

        tk.Label(self, text="Прикрепленный файл:").grid(row=5, column=0, sticky=tk.W, padx=10, pady=5)
        ...
        tk.Button(self, text="Добавить проект", command=self.add_project).grid(row=6, column=0, columnspan=3, pady=10)
        tk.Button(self, text="Выход", command=self.logout).grid(row=7, column=0, columnspan=3, pady=10)
        ...
        tk.Button(self, text="Список пользователей", command=self.show_users).grid(row=9, column=0, columnspan=3,
                                                                                   pady=5)
        tk.Button(self, text="Удалить свой аккаунт", command=self.delete_own_account).grid(row=10, column=0,
                                                                                           columnspan=3, pady=5)
